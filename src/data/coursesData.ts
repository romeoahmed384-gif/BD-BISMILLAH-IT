...
export const COURSES_DATA: Course[] = [
  ...
  // 09. অফিস অ্যাপ্লিকেশন (৩ মাস)
  {
    ...
    shortDescription: 'MS Word, Excel, PowerPoint, বাংলা ও ইংরেজি দ্রুত টাইপিং এবং ইন্টারনেট ব্রাউজিং। নিয়মিত ফি ৩,০০০৳, ৪০% বিশেষ ছাড়ে মাত্র ১,৮০০৳।',
    instructor: {
    ...
    features: [
      'কোর্স ফি: ৩,০০০/- টাকা (৪০% বিশেষ ছাড়ে মাত্র ১,৮০০/- টাকা)',
  ...
  // 10. অফিস অ্যাপ্লিকেশন (এডভান্সড)
  {
    ...
    shortDescription: 'MS Office ডিপ্লোমা, অ্যাডভান্সড এক্সেল, অ্যাক্সেস ডেটাবেস, সরকারি ফরম্যাটিং ও কারিগরি বোর্ড সার্টিফিকেট। নিয়মিত ফি ৬,০০০৳, ৪০% বিশেষ ছাড়ে মাত্র ৩,৬০০৳।',
    instructor: {
      name: 'মো: রফিকুল ইসলাম',
      designation: 'সার্টিফাইড অফিস স্পেশালিস্ট ও একাডেমি মেন্টর',
      experience: '১২+ বছর ট্রেনিং অভিজ্ঞতা',
    ...
    features: [
      'কোর্স ফি: ৬,০০০/- টাকা (৪০% বিশেষ ছাড়ে মাত্র ৩,৬০০/- টাকা)',
  ...
  // 11. অফিস অ্যাপ্লিকেশন (৯ মাস)
  {
    ...
    shortDescription: 'এক্সক্লুসিভ ৯ মাস মেয়াদী মাস্টার অফিস অ্যাপ্লিকেশন, হার্ডওয়্যার ট্রাবলশুটিং ও অফিস আইটি অ্যাডমিনিস্ট্রেশন। নিয়মিত ফি ৯,০০০৳, ৪০% বিশেষ ছাড়ে ৫,৪০০৳।',
    instructor: {
      name: 'মো: রফিকুল ইসলাম',
      designation: 'সার্টিফাইড অফিস স্পেশালিস্ট ও একাডেমি মেন্টর',
      experience: '১২+ বছর ট্রেনিং অভিজ্ঞতা',
    ...
    features: [
      'কোর্স ফি: ৯,০০০/- টাকা (৪০% বিশেষ ছাড়ে মাত্র ৫,৪০০/- টাকা)',
  ...
  // 12. অফিস অ্যাপ্লিকেশন + আউটসোর্সিং (৬ মাস)
  {
    ...
    shortDescription: 'MS Office, ডেটা এন্ট্রি (Data Entry), ওয়েব রিসার্চ, ভার্চুয়াল অ্যাসিস্ট্যান্ট ও Fiverr/Upwork আউটসোর্সিং। নিয়মিত ফি ৭,০০০৳, ৪০% বিশেষ ছাড়ে ৪,২০০৳।',
    instructor: {
    ...
    features: [
      'কোর্স ফি: ৭,০০০/- টাকা (৪০% বিশেষ ছাড়ে মাত্র ৪,২০০/- টাকা)',
