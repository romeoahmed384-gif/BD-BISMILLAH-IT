    ...
    <section className="relative overflow-hidden bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-white pt-6 pb-16 lg:pt-10 lg:pb-20 border-b border-slate-800/80">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-6">
        ...
        <div className="grid grid-cols-12 gap-4 lg:gap-6 items-stretch">
          ...
          {/* Bento Tile 1: Major Headline & Action Hub (Span 8) */}
          <div className="col-span-12 lg:col-span-8 bg-slate-900/90 rounded-3xl p-6 sm:p-8 lg:p-10 border border-slate-800 hover:border-slate-700/80 shadow-2xl backdrop-blur-md flex flex-col justify-between relative overflow-hidden transition-all duration-300">
            ...
            <div className="space-y-5">
              {/* Top Banner Tag */}
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-rose-950/70 border border-rose-500/30 text-rose-300 text-xs sm:text-sm font-semibold shadow-inner">
                <Sparkles className="w-4 h-4 text-amber-400" />
                <span>নতুন সেশনে ভর্তি চলছে • অনলাইন ও অফলাইন স্পেশাল ব্যাচ</span>
                <span className="bg-rose-600 text-white text-[10px] font-black px-2 py-0.5 rounded-full">৫০% ছাড়</span>
              </div>

              {/* Display Title */}
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-[2.85rem] font-black leading-tight tracking-tight text-white">
            ...
            {/* Bottom Actions & 8th Branch Notification */}
            <div className="pt-6 space-y-4">
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
                <button
                  onClick={() => onOpenAdmission()}
                  className="inline-flex items-center justify-center gap-2.5 bg-gradient-to-r from-rose-600 via-rose-500 to-red-600 hover:from-rose-500 hover:to-red-500 text-white px-6 py-3.5 rounded-2xl text-sm font-bold shadow-lg shadow-rose-900/40 hover:shadow-rose-700/60 transition-all hover:scale-[1.02] active:scale-95 group"
                >
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center gap-2 bg-emerald-700/90 hover:bg-emerald-600 text-white px-5 py-3.5 rounded-2xl text-xs sm:text-sm font-bold border border-emerald-500/40 transition-all hover:scale-[1.02]"
                >
                ...
                <button
                  onClick={onOpenChat}
                  className="inline-flex items-center justify-center gap-2 bg-slate-800 hover:bg-slate-700/90 text-sky-300 px-4 py-3.5 rounded-2xl text-xs sm:text-sm font-semibold border border-slate-700 hover:border-sky-500/40 transition-all"
                >
          ...
          {/* Bento Tile 2: Visual Lab Showcase & Media Frame (Span 4) */}
          <div className="col-span-12 lg:col-span-4 bg-slate-900/90 rounded-3xl p-5 border border-slate-800 hover:border-slate-700/80 shadow-2xl backdrop-blur-md flex flex-col justify-between relative overflow-hidden transition-all duration-300">
            <div className="space-y-4">
              ...
              <div
                className="relative rounded-2xl overflow-hidden aspect-video group cursor-pointer border border-slate-800"
                onClick={() => onOpenAdmission()}
              >
                <img
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-slate-950 via-slate-900/30 to-transparent flex flex-col justify-end p-3.5">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-[11px] text-amber-300 font-semibold">হ্যান্ডস-অন ট্রেনিং</p>
                      <h4 className="text-sm font-bold text-white leading-tight">অত্যাধুনিক মাল্টিমিডিয়া ক্লাসরুম</h4>
                    </div>
                    <div className="w-9 h-9 rounded-full bg-rose-600 text-white flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform">
            ...
            <div className="pt-3">
              <button
                onClick={() => onOpenAdmission()}
                className="w-full py-2.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-200 hover:text-white border border-slate-700 text-xs font-bold transition-all text-center"
              >
                ফ্রি ক্লাসরুম ভিজিট বুক করুন →
              </button>
            </div>
          </div>
        ...
        {/* Bento Grid Bottom Row: 4 Metric Bento Boxes */}
        <div className="grid grid-cols-12 gap-4 lg:gap-6">
          
          {/* Metric 1: Students */}
          <div className="col-span-12 sm:col-span-6 lg:col-span-3 bg-slate-900/80 hover:bg-slate-900 rounded-2xl p-5 border border-slate-800 hover:border-rose-500/40 transition-all duration-300 shadow-md flex items-center gap-4 group">
          ...
          <div className="col-span-12 sm:col-span-6 lg:col-span-3 bg-slate-900/80 hover:bg-slate-900 rounded-2xl p-5 border border-slate-800 hover:border-emerald-500/40 transition-all duration-300 shadow-md flex items-center gap-4 group">
          ...
          {/* Metric 3: Branches */}
          <div className="col-span-12 sm:col-span-6 lg:col-span-3 bg-slate-900/80 hover:bg-slate-900 rounded-2xl p-5 border border-slate-800 hover:border-sky-500/40 transition-all duration-300 shadow-md flex items-center gap-4 group">
          ...
          {/* Metric 4: Mentors */}
          <div className="col-span-12 sm:col-span-6 lg:col-span-3 bg-slate-900/80 hover:bg-slate-900 rounded-2xl p-5 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 shadow-md flex items-center gap-4 group">
